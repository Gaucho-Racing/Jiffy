...
func InitializeRoutes(router *gin.Engine) {
	...
	router.GET("/purchaserequests", GetAllPurchaseRequests)
	router.GET("/purchaserequests/:purchaserequestID", GetPurchaseRequestByID)
	router.POST("/purchaserequests", CreatePurchaseRequest)
	router.PATCH("/purchaserequests/:purchaserequestID/status", UpdatePurchaseRequestStatus)
	router.PATCH("/approvals/:approvalID", EditApproval)
