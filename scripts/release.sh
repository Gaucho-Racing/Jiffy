...
echo "Building container for Jiffy v$VERSION"
# Build the docker container
docker build -t gauchoracing/jiffy:"$VERSION" -t gauchoracing/jiffy:latest --platform linux/amd64,linux/arm64 --push --progress=plain .
